<main>
      <ul>
                 <li><img src=".//assete/lutte.jpg" alt="" loading="lazy"></li>
                <li><img src=".//assete/foot.jpg" alt="" loading="lazy"></li>
                <li><img src=".//assete/volley.jpg" alt="" loading="lazy"></li>
                <li><img src=".//assete/tennis.jpg" alt="" loading="lazy"></li>
      </ul>
      <fieldset>
      <legend>Sign In</legend>
        <form method="post" action="./src/accueil.php">
 ...
 <select id="city" name="city">
    ...
    <option value="Evry">Evry</option>
     ...
     <select id="country" name="country">
      ...
      <button name="valider" type="submit" class="btn-default">Sign In</button>
    </form>
</fieldset>
    </main>